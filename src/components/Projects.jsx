...
export default function Projects() {
  return (
    <section id="projects" style={{ padding: '96px 0', background: '#0a0a0a' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: 20 }}>
          {projects.map(p => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-heading" style={{ fontSize: 19, fontWeight: 700, color: '#fff', letterSpacing: '-0.3px', marginBottom: 10 }}>
                {p.name}
              </h3>

              {/* Description */}
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 14, color: '#52525b', lineHeight: 1.8, marginBottom: 18, flex: 1 }}>
                {p.desc}
              </p>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                {p.live && (
                  <a
                    ...
                    onMouseEnter={e => { e.currentTarget.style.filter = 'brightness(1.1)'; e.currentTarget.style.boxShadow = `0 0 20px ${p.accent}55`; }}
